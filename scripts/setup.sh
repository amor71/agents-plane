...
echo -e "  2. Name the project: click ${BOLD}\"Untitled project\"${NC} at top → type ${BOLD}\"Agents Plane\"${NC}"
echo -e "  3. Select all code in the editor (⌘+A) and paste the trigger code (⌘+V)"
echo -e "     ${DIM}(copied to clipboard if on macOS)${NC}"
echo -e "  4. ${BOLD}Save${NC} (⌘+S)"
echo -e "  5. Enable the ${BOLD}Admin SDK${NC} advanced service:"
echo -e "     Left sidebar → ${BOLD}Services${NC} (+ icon) → search ${BOLD}\"Admin SDK API\"${NC} → ${BOLD}Add${NC}"
echo -e "  6. Run ${BOLD}createCustomSchema${NC} first:"
echo -e "     Function dropdown (top bar) → select ${BOLD}createCustomSchema${NC} → click ${BOLD}▶ Run${NC}"
echo -e "     ${DIM}(Authorize when prompted — this creates the schema in Admin Console)${NC}"
echo -e "  7. Set up the polling trigger:"
echo -e "     Left sidebar → ${BOLD}Triggers${NC} (clock icon) → ${BOLD}Add Trigger${NC}"
...
echo -e "  8. Click ${BOLD}Save${NC} and authorize"
echo -e "  9. Deploy: ${BOLD}Deploy${NC} → ${BOLD}New deployment${NC} → Type: ${BOLD}Web app${NC}"
echo -e "     Description: ${BOLD}Agents Plane${NC}"
echo -e "     Execute as: ${BOLD}Me${NC} → Who has access: ${BOLD}Only myself${NC} → ${BOLD}Deploy${NC}"
echo ""
echo -e "  ${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
