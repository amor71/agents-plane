...
clear
echo ""
# Box in bright cyan, AGENTS in bold magenta, PLANE in bold blue
B="\033[1;36m"  # bright cyan for box
A="\033[1;35m"  # magenta for AGENTS
P="\033[1;34m"  # blue for PLANE
S="\033[38;5;243m"  # dim for shadows
R="\033[0m"
echo -e "${B}  ┌──────────────────────────────────────────────────────────┐${R}"
echo -e "${B}  │${R}                                                          ${B}│${R}"
echo -e "${B}  │${R}   ${A} █████╗  ██████╗ ███████╗███╗   ██╗████████╗███████╗${R} ${B}│${R}"
