...
echo -e "  3. ${BOLD}Save${NC} the project (Ctrl+S / ⌘+S)"
echo -e "  4. Enable the ${BOLD}Admin SDK${NC} advanced service:"
echo -e "     Left sidebar → ${BOLD}Services${NC} (+ icon) → search \"Admin SDK API\" → ${BOLD}Add${NC}"
echo -e "  5. Set up a trigger: Left sidebar → ${BOLD}Triggers${NC} (clock icon) → ${BOLD}Add Trigger${NC}"
...
echo -e "  6. Click ${BOLD}Save${NC} and authorize when prompted"
echo ""
echo -e "  ${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
